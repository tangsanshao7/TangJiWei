...
// if (yue>0&&yue<13) {
//     if (yue>2&&yue<6) {
//         console.log(yue+"月份是春季");
//     }else if (yue>5&&yue<9) {
//         console.log(yue+"月份是夏季");
//     }else if (yue>8&&yue<12) {
//         console.log(yue+"月份是秋季");
//     }else{
//         console.log(yue+"月份是冬季");
//     }
// }else{
...
// var num2 = parseInt(num / 1000 % 10);
// var num3 = parseInt(num / 100 % 10);
// var num4 = parseInt(num / 10 % 10);
// var num5 = parseInt(num % 10);
...
// console.log('如果几天是星期六,那么今天是星期' + (teday + x - 7));
