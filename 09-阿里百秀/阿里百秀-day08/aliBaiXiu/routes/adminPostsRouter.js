...
// 3.引入控制器方法
const { postsPage, postsAddPage, postsByFilter, postsDeleteById, postsEditPage, postsEdit, postsAdd, postsCategoryPage, postsFindCategory, postsAddCategory } = require('../controllers/adminPostsCtrl');
// 4.创建具体路由
// 4.1 显示文章管理页面
